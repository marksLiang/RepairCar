...
class LoginViewController: UITableViewController,UITextFieldDelegate  {
    ...
    //注册逻辑( 获取验证码回调事件 )
    typealias CallbackRegisterVerificationCodeValue=(_ phone:String)->Void
    ...
    //忘记密码逻辑( 获取验证码回调事件 )
    typealias CallbackForgetpasswordVerificationCodeValue=(_ phone:String)->Void
    ...
    @IBAction func register(_ sender: AnyObject) {
        ...
        //验证码
        vc.Callback_VerificationCodeValue { (phone) in
            if(self.RegisterVerificationCodeCallbackValue != nil ){
                self.RegisterVerificationCodeCallbackValue!(phone)
            }
        }
        //提交回调
    ...
    @IBAction func forget_password(_ sender: AnyObject) {
        ...
        vc.Callback_VerificationCodeValue { (phone) in
            if(self.ForgetpasswordVerificationCodeCallbackValue != nil ){
                self.ForgetpasswordVerificationCodeCallbackValue!(phone)
            }
        } 
        //提交回调
        vc.Callback_SubmitValue { (phone, password, againpassword, VerificationCode) in
