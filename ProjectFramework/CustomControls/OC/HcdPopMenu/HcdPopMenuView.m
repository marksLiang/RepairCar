...
@property (nonatomic, strong) selectGBCompletionBlock gbblock;
@property (nonatomic, strong) UIImageView *exitView;
@property (nonatomic, strong) UIImageView *bgImageView;
@property (nonatomic, strong) UILabel     *tipsLbl;
@property (nonatomic,assign) BOOL  isItemMenu;
@end
...
- (void)initUI {
    ...
    [bottomView setBackgroundColor:[UIColor colorWithWhite:1.f alpha:0.00f]];
...
- (void)setSelectbgCompletionBlock:(selectGBCompletionBlock)block {
    _gbblock = block;
}
@end
